...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108weiz2";
	public static final String MYSQL_PASSWORD = "roeghaix";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_weiz2";
